...
class LevelupAction extends CaifubaseAction {
	...
	public function lists($status=1,$member_id=null) {
		$map = array(); $model = new CfLevelupModel(); $member_M = New CfMemberModel();
		$map['status'] = $status;
